  ...
  return (
    <main className="flex flex-col items-center w-full min-w-[340px] text-xs sm:text-base mb-20">
      ...
      <div className="relative flex sm:flex-row flex-col flex-wrap items-center justify-center w-full sm:p-2 p-0 gap-4 sm:pr-[320px] mb-8">
        <div className="border-box w-auto h-auto flex flex-col items-center justify-center shadow-2xl shadow-tertiary">
          <h2 className="font-bold text-2xl box-info">
            Inflows and Outflows per month
          </h2>

          <div className="flex w-[600px] h-auto m-4 border-2 border-black">
